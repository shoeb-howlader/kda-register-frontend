    ...
    <div>
        <div class="card">
            ...
            <DataTable :value="customers1" :paginator="true" class="p-datatable-customers" showGridlines :rows="10"
                ...
                <Column field="name" header="Current User" style="min-width:12rem">
                    <template #body="{data}">
                        {{data.name}}
                    </template>
                ...
                <Column header="Supplier" filterField="country.name" style="min-width:12rem">
                    <template #body="{data}">
                ...
                <Column header="Category" filterField="representative" :showFilterMatchModes="false" :filterMenuStyle="{'width':'14rem'}" style="min-width:14rem">
                    <template #body="{data}">
                ...
                <Column header="Purchase date" filterField="date" dataType="date" style="min-width:10rem">
                    <template #body="{data}">
