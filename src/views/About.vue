...
<Toast />
    <div>
      ...
      <div class="myname-designation" id="myname-designation"></div>
...
var test = typewriter.typeString(`<span style="color:green">KDA Register Management Software</span> is a web-based software built with MEVN (MongoDB,Express,Vue,Node) stack to make Computer Sectcion's Register maintainance easy.
...
UI(User Interface) in run time.that's all in short. 
`)
    .pauseFor(250)
    .typeString(`<div class="myname-about">Shoeb Howlader</div>`)
    .callFunction((state) => {
         // turn off animation
...
typewriter2.changeDeleteSpeed(75)
